...
#define DEBUG_MESSAGE(type, fmt...) { if (DSSP_DEBUG & type) __android_log_print(ANDROID_LOG_INFO, "hexter", fmt); }
#define GUIDB_MESSAGE(type, fmt...) { if (DSSP_DEBUG & type) __android_log_print(ANDROID_LOG_INFO, "hexter", fmt); }
#define TUIDB_MESSAGE(type, fmt...) { if (DSSP_DEBUG & type) __android_log_print(ANDROID_LOG_INFO, "hexter", fmt); }
