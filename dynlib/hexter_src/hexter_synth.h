...
struct _hexter_instance_t
{
    ...
    int             new_program; /* used by vuknob to indicate a new program */
    int             current_program;
    ...
    unsigned int   cc_volume;                /* volume msb*128 + lsb, max 16256 */
...
char *hexter_instance_handle_performance(hexter_instance_t *instance,
                                         const char *value);
void  hexter_synth_render_voices(unsigned int samples_done,
                                 unsigned int sample_count, 
                                 int do_control_update);
void hexter_synth_render_instance_voices(hexter_instance_t *instance,
